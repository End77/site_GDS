...
// Validate ../../src/app/pricing-calculator/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/pricing-calculator">> = Specific
  const handler = {} as typeof import("../../src/app/pricing-calculator/page.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
