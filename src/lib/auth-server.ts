// Этот файл предназначен только для серверного кода.
// Не импортируйте его в 'use client' компоненты.

import bcrypt from 'bcryptjs';
import { db } from '@/lib/db';
import { jwtVerify, SignJWT } from 'jose';

// ВАЖНО: Убедитесь, что JWT_SECRET добавлен в ваш .env.local файл
const JWT_SECRET = new TextEncoder().encode(process.env.JWT_SECRET || 'your-super-secret-fallback-key');
